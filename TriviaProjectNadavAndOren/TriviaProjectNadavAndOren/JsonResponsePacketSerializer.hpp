...
public:
    ...
    static const std::vector<unsigned char> serializeResponse(const CheckForEndReponse& response)
    {
        json j = { {"gameEnded", response.gameEnded} };
        return createBuffer(1, j.dump());
    }

    static const std::vector<unsigned char> serializeResponse(const leaderBoardResponse& response)
    {
        json players = json({});
    ...
    static const std::vector<unsigned char> serializeResponse(const GetPlayesInRoomResponse& response)
    {
        json j = {};
    ...
    static const std::vector<unsigned char> serializeResponse(const getHighScoreResponse& response)
    {
    ...
    static const std::vector<unsigned char> serializeResponse(const AddQuestionResponse& response)
    {
        json j = { {"status", response.status} };
        return createBuffer(1, j.dump());
    }
...
private:
    static const std::vector<unsigned char> createBuffer(uint8_t code, const std::string& jsonString)
    {
